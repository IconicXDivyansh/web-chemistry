...
export default function HeroTitle(){
    ...
    useEffect(() => {
        animate(
          [
            [scope.current, {scale: [0.5,1]}, {duration: 1.2, ease: "easeOut", delay: 0.2}],
            ['h1', {opacity: [0,1], y:[10, 0], filter: ["blur(10px)", "blur(0px)"]}, {duration: 1, type: "spring", bounce: 0.3,}],
            ['li', {opacity: [0,1], y:[10, 0],scale: ["0.5", "1"] ,filter: ["blur(10px)", "blur(0px)"]}, {duration: 1, type: "spring", bounce: 0.3}],
          ]
        )
      }, [])
